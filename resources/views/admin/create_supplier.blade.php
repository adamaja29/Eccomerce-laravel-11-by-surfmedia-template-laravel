...
<div class="main-content-inner">
    <div class="main-content-wrap">
        ...
        <!-- new-category -->
        <div class="wg-box">
            <form class="form-new-product form-style-1" action="{{route('admin.store.supplier')}}" method="POST"
                ...
                <fieldset class="name">
                    ...
                    <input class="flex-grow" type="text" placeholder="Nama" name="nama"
                        tabindex="0" value="{{ old('nama')}}" aria-required="true" required="">
                </fieldset>
                ...
                <fieldset class="email">
                    ...
                    <input class="flex-grow" name="email" placeholder="Email" type="email"
                        tabindex="0" value="{{old('email')}}" aria-required="true" required=""></input>
                </fieldset>
                ...
                <fieldset class="kontak">
                    ...
                    <input class="flex-grow" name="kontak" placeholder="kontak" type="number"
                        tabindex="0" value="{{old('kontak')}}" aria-required="true" required=""></input>
                </fieldset>
                ...
                <fieldset class="alamat">
                    ...
                    <textarea class="flex-grow" name="alamat" placeholder="alamat"
                        tabindex="0" aria-required="true" required="">{{old('alamat')}}</textarea>
                ...
                <fieldset class="nama_bank">
                    ...
                    <input class="flex-grow" name="nama_bank" placeholder="nama_bank" type="text"
                        tabindex="0" value="{{old('nama_bank')}}" aria-required="true" required=""></input>
                ...
                <fieldset class="nomor_bank">
                    ...
                    <input class="flex-grow" name="nomor_bank" placeholder="nomor_bank" type="number"
                        tabindex="0" value="{{old('nomor_bank')}}" aria-required="true" required=""></input>
                </fieldset>
                ...
                <fieldset class="atas_nama">
                    ...
                    <input class="flex-grow" name="atas_nama" placeholder="atas_nama" type="text"
                        tabindex="0" value="{{old('atas_nama')}}" aria-required="true" required=""></input>
                </fieldset>
