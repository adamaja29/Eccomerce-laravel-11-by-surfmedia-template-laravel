...
<div class="main-content-inner">
    <div class="main-content-wrap">
        ...
        <!-- new-category -->
        <div class="wg-box">
            <form class="form-new-product form-style-1" action="{{ route('admin.store.kategori')}}" method="POST"
                ...
                @enderror
                <fieldset class="name">
                    <div class="body-title">Kode <span class="tf-color-1">*</span></div>
                    <input class="flex-grow" type="text" placeholder="Kode" name="kode"
                        tabindex="0" value="{{ old('kode')}}" aria-required="true" required="">
                </fieldset>
