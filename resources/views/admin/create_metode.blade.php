    ...
    <div class="main-content-wrap">
        <div class="flex items-center flex-wrap justify-between gap20 mb-27">
            ...
            <ul class="breadcrumbs flex items-center flex-wrap justify-start gap10">
                ...
                <li>
                    <a href="{{ route('admin.create.metode') }}">
                        <div class="text-tiny">Pembayarn</div>
                    </a>
                </li>
                <li>
                    <i class="icon-chevron-right"></i>
        ...
        <!-- new-category -->
        <div class="wg-box">
            <form class="form-new-product form-style-1" action="{{route('store.metode')}}" method="POST"
                ...
                <fieldset class="deskripsi">
                    ...
                    <textarea class="mb-10" name="deskripsi" placeholder="deskripsi"
                        tabindex="0" aria-required="true" required="">{{old('deskripsi')}}</textarea>
